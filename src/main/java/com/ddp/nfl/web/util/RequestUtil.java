...
public final class RequestUtil{
    ...
    public final static UserInfo createUserInfo( String userName, HttpServletRequest request ) {
        UserInfo userInfo = null;
        
        try {
            userInfo    = new UserInfo( userName, getUserAgent( request ), getClientOS( request ), 
                                    getClientBrowser( request ), getClientIpAddr( request), 
                                    getFullURL( request ), getReferer( request ) );
        }catch (Exception e) {
            userInfo    = new UserInfo( userName, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY );
        }
    ...
    //http://stackoverflow.com/a/18030465/1845894
    public final static  String getClientOS(HttpServletRequest request) {
    ...
    //http://stackoverflow.com/a/18030465/1845894
    public final static  String getClientBrowser(HttpServletRequest request) {
        final String browserDetails = request.getHeader("User-Agent");
