...
public final class Punting{
    ...
    public Punting( String name, int pts, int ygs, int avg, int i20, int lng ){
        this.name = name;
        this.pts = pts;
        this.ygs = ygs;
        this.avg = avg;
    ...
    public final String toString( ) {
        ...
        builder.append( "Punting [name=" ).append( name ).append( ", pts=" ).append( pts ).append( ", ygs=" ).append( ygs );
